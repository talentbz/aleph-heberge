...
return [
    ...
    'same_account_error' =>
        'Anda Tidak Bisa Melakukan Transfer Antar Sesama Akun',
    ...
    'tr_delete_warning' =>
        'Menghapus Transaksi tidak dapat dibatalkan . Saldo saat ini dengan akun terkait akan disesuaikan. ',
    ...
    'frequency_help' =>
        'Misalnya Jika Anda memilih Frekuensi Bulanan , Anda dapat menempatkan Jumlah Pembayaran 12. Itu akan mengulang transaksi selama 12 bulan ke depan.',
    ...
    'drag_drop_edit' =>
        'Geser dan letakkan item di bawah ini untuk Repositioning . Klik untuk mengedit.',
    ...
    'cat_del_help_txt' =>
        'Menghapus Kategori akan mengubah nama semua transaksi dalam kategori ini ke Uncategorized ',
    ...
    'user_type_help' =>
        'Pilih Jenis Pengguna Karyawan untuk menonaktifkan akses ke Pengaturan!',
    ...
    'currency_help' =>
        'Tetap kosongkan jika Anda tidak ingin menampilkan kode mata uang',
    ...
    'Message Should be between 5 to 1000 characters' =>
        'Isi Pesan Harus antara 5 hingga 1000 karakter',
    ...
    'Check your email to reset Password' =>
        'Periksa Email Anda untuk me-reset kata sandi',
    ...
    'Optional Description help' =>
        'Uraian opsional, akan ditampilkan sebagai bantuan block',
    ...
    'Enter to set the next invoice' =>
        'Masukkan untuk mengatur nomor faktur berikutnya , harus lebih besar dari nilai kenaikan otomatis sekarang',
    'Keep Blank for' => 'Tetap kosong untuk tidak ada perubahan',
    'This will replace existing logo' =>
        'Ini akan menggantikan logo yang ada . Anda juga dapat mengubah logo dengan mengganti file',
    ...
    'to_enable_automation' =>
        'Untuk mengaktifkan fitur otomatisasi, pastikan Anda mengatur tugas cron untuk menjalankan satu kali per hari . ( Misal 09:00 ).',
    'Create the following Cron Job using GET' =>
        'Buat Cron Job menggunakan GET:',
    'Or' => 'Or',
    'Create the following Cron Job using PHP' =>
        'Buat Cron Job menggunakan PHP:',
    'Create the following Cron Job using WGET' =>
        'Buat Cron Job menggunakan WGET:',
    ...
    'All Outgoing Email Will' =>
        'Semua Email Keluar Akan dikirim dari Alamat Email ini.',
    'SMTP Host' => 'SMTP Host',
    ...
    'Keep it blank if currency code' =>
        'Tetap kosong jika Anda tidak ingin menampilkan kode mata uang',
    'Charset n Collation' => 'Charset & Collation',
    'Set Charset n Collation' =>
        'Atur Charset & Collation Untuk Tabel Database',
    'Sign in' => 'Masuk',
    ...
    'Choose User Type' =>
        'Pilih Jenis Pengguna Karyawan untuk menonaktifkan akses Pengaturan',
    ...
    'quote_number_help' =>
        'Tetap kosong untuk Menghasilkan Nomor Penawaran otomatis',
    'invoice_number_help' =>
        'Tetap kosong untuk Menghasilkan Nomor Faktur otomatis',
    ...
    'Admin:Password Change Request' =>
        'Admin - Permintaan perubahan kata sandi',
    'Admin:New Password' => 'Admin - Kata Sandi Baru',
    'Invoice:Invoice Payment Reminder' =>
        'Faktur - Pengingat Pembayaran Faktur',
    'Invoice:Invoice Overdue Notice' =>
        'Faktur - Pemberitahuan Jatuh Tempo Faktur',
    'Invoice:Invoice Payment Confirmation' =>
        'Faktur - Konfirmasi Pembayaran Faktur',
    'Invoice:Invoice Refund Confirmation' =>
        'Faktur - Konfirmasi Refund Faktur',
    ...
    'notice_email_as_username' =>
        'Gunakan alamat email yang valid sebagai pengguna',
    'API' => 'API',
    ...
    'cron_invoice_created' =>
        'CRON Job - Secara otomatis Kirim Faktur Yang Telah Dibuat Melalui Email',
    ...
    'Send Client Signup Email' =>
        'Atur Ya untuk mengirim Email Pendaftaran Klien.',
    'Profile' => 'Profil',
    'Download' => 'Unduh',
    'Legacy' => 'Legacy',
    'New' => 'Baru',
    ...
    'Create tasks automatically from ticket' =>
        'Buat tugas secara otomatis dari tiket',
    'Expertise' => 'Keahlian',
    ...
    'Send sms notification to admin when ticket is assigned' =>
        'Kirim notifikasi sms ke admin saat tiket ditugaskan',
    'Admin - Disable customer welcome email' =>
        'Admin - Nonaktifkan email sambutan pelanggan',
    'Option to enabled Add Fund to Client' =>
        'Opsi untuk mengaktifkan Tambahkan Dana ke Klien',
    'Minimum Deposit' => 'Setoran Minimum',
    'Enter the minimum amount a client can add in a single transaction' =>
        'Masukkan jumlah minimum yang dapat ditambahkan klien dalam satu transaksi',
    'Maximum Deposit' => 'Setoran Maksimal',
    'Enter the maximum amount a client can add in a single transaction' =>
        'Masukkan jumlah maksimum yang dapat ditambahkan klien dalam satu transaksi',
    'Enable Add Fund Option from Client Portal' =>
        'Aktifkan Tambahkan Opsi Dana dari Portal Klien',
    'Adding of funds by clients from the client dashboard' =>
        'Menambahkan dana oleh klien dari dasbor klien',
    ...
    'Showing _START_ to _END_ of _TOTAL_ entries' =>
        'Menampilkan _START_ hingga _END_ dari _TOTAL_ entri',
