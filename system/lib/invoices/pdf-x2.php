...
*/
        ...
        * { margin: 0; padding: 0; }
        ...
        #terms h5 { text-transform: uppercase; font: 13px <?php echo $config[
            'pdf_font'
        ]; ?>; letter-spacing: 10px; border-bottom: 1px solid black; padding: 0 0 8px 0; margin: 0 0 8px 0; }
...
<!--                    --><?php
        ...
        <?php if ($d['tax'] != '0.00') { ?>
            <tr>
                ...
                <td class="blank"> </td>
                <td colspan="<?php echo $col_span; ?>" class="total-line"><?php if (
