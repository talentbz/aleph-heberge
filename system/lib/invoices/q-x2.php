...
<div id="page-wrap">
    ...
    <table width="100%">
        <tr>
            <td style="border: 0;  <?php if ($config['rtl'] == 1) {
                ...
                <span style="font-size: 18px; color: #2f4f4f"><strong><?php echo $_L[
                    'Quote'
                ]; ?> # <?php
 if ($d['cn'] != '') {
     $dispid = $d['cn'];
 ...
 ?></strong></span>
            ...
            <td style="border: 0;  text-align: right" width="62%"><div id="logo" style="font-size:18px">
                    <img id="image" src="<?php echo APP_URL; ?>/storage/system/<?php echo $config[
    'logo_default'
]; ?>" alt="logo" />  <br> <br>
    ...
    <div id="customer">
        ...
        <table id="meta">
            <tr>
                <td rowspan="5" style=" <?php if ($config['rtl'] == 1) {
                    echo 'border: 1px solid white; border-left: 1px solid black; text-align: right"';
                } else {
                    echo 'border: 1px solid white; border-right: 1px solid black; text-align: left"';
                } ?>  width="62%"> <strong><?php echo $_L[
      'Recipient'
  ]; ?>:</strong> <br>
                    <?php if ($a['company'] != '') { ?>
    ...
    <table id="items">
        ...
        <?php foreach ($items as $item) {
            ...
            <td align="right"><span class="price">' .
                formatCurrency($item['total'], $d['currency_iso_code']) .
                '</span></td>
        </tr>';
        } ?>
        ...
        <tr>
            <td class="blank"> </td>
            <td colspan="2" class="total-line"><?php echo $_L[
                'Sub Total'
            ]; ?></td>
        ...
        <?php if ($d['tax1'] != '0.00' and $d['tax1'] != '') { ?>
            <tr>
                ...
                <td class="blank"> </td>
                <td colspan="2" class="total-line"><?php echo $d[
                    'taxname'
                ]; ?></td>
        ...
        <?php } ?>
            ...
            <tr>
                <td class="blank"> </td>
                <td colspan="2" class="total-line balance"><?php echo $_L[
                    'Grand Total'
                ]; ?></td>
