...
');
        ...
        if (!db_table_exist('contracts')) {
            ...
            //  `description` text COLLATE utf8mb4_unicode_ci,
            //  `party_one_name` varchar(161) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
            //  `party_one_sign` varchar(161) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
            //  `party_two_name` varchar(161) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
            //  `party_two_sign` varchar(161) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
