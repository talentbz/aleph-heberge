...
<a href="{$_url}purchases/add/1/{$cid}/" class="btn btn-primary waves-effect waves-light"><i class="fal fa-plus"></i> {$_L['New Purchase Order']}</a>
    ...
    {foreach $i as $ds}
        <tr>
            ...
            <td class="text-right">
                ...
                <a href="{$_url}purchases/view/{$ds['id']}/" class="btn btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="{$_L['View']}"><i class="fal fa-file-text-o"></i></a>
                <a href="{$_url}purchases/clone/{$ds['id']}/" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title="{$_L['Clone']}"><i class="fal fa-files-o"></i></a>
                <a href="{$_url}purchases/edit/{$ds['id']}/" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="{$_L['Edit']}"><i class="fal fa-pencil"></i></a>
