            ...
            <form method="post" action="{$_url}client/register_post/" id="iform">
                <div class="panel panel-default alt md-card">
                    ...
                    <div class="panel-body">
                        <form action="" class="">
                            <div class="form-group">
                                <label for="fullname" class="control-label">{$_L['Full Name']}</label>
                    ...
                    <div class="panel-footer">
                        <div class="clearfix">
                            <a href="{$_url}client/login/" class="pull-left mt-xs">{$_L['Already Registered? Login']}</a>
                            <button type="submit" id="btn_form_action" class="btn btn-primary pull-right">{$_L['Register']}</button>
                        </div>
                    </div>
                </div>
            </form>
