...
{block name="content"}
    <div class="row" id="ibox_form">
        ...
        <div class="col-md-12">
            <h3 class="ibilling-page-header">{$_L['Purchase']} {$_L['Invoice']}</h3>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="hidden" id="ddate" name="ddate" value="{$i['duedate']}">
                                    </div>
                                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <textarea class="form-control" name="notes" id="notes" rows="3"
                                  placeholder="Supplier Notes...">{$i['notes']}</textarea>
                        <br>
                        {*{if $recurring}*}
